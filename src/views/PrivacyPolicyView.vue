  ...
  <section class="max-w-7xl mx-auto px-4 py-6">
    <div class="mb-8">
      ...
      <p class="mb-4">
        ...
        of Fire Alert Mobi (Pty) Ltd's Website, located at
        https://www.firealert.mobi.
      </p>
      <p class="mb-4">
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Fire Alert if you do not agree to
      ...
      <p>
        ...
        subject to, prevailing law of za. Any use of the above terminology or
    ...
    <div class="mb-8">
      ...
      <p class="mb-4">
        Unless otherwise stated, Fire Alert Mobi (Pty) Ltd and/or its licensors
        own the intellectual property rights for all material on Fire Alert. All
        intellectual property rights are reserved. You may access this from Fire
        Alert for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>
      <p class="mb-4">You must not:</p>
      <ul class="mb-3 pl-10 list-disc">
        <li>Republish material from Fire Alert</li>
        <li>Sell, rent or sub-license material from Fire Alert</li>
        <li>Reproduce, duplicate or copy material from Fire Alert</li>
        <li>Redistribute content from Fire Alert</li>
      </ul>
      <p class="mb-4">
      ...
      <p class="mb-4">
        ...
        exchange opinions and information in certain areas of the website. Fire
        Alert Mobi (Pty) Ltd does not filter, edit, publish or review Comments
        prior to their presence on the website. Comments do not reflect the
        views and opinions of Fire Alert Mobi (Pty) Ltd,its agents and/or
        ...
        laws, Fire Alert Mobi (Pty) Ltd shall not be liable for the Comments or
      ...
      <p class="mb-4">
        Fire Alert Mobi (Pty) Ltd reserves the right to monitor all Comments and
      ...
      <p>
        You hereby grant Fire Alert Mobi (Pty) Ltd a non-exclusive license to
    ...
    <div class="mb-8">
      <h3 class="mb-4 text-2xl font-bold">Hyperlinking to our Content</h3>
      <p class="mb-4">
      ...
      <p class="mb-4">
        ...
        the hyperlink compensates the absence of Fire Alert Mobi (Pty) Ltd; and
      ...
      <p class="mb-4">
        ...
        e-mail to Fire Alert Mobi (Pty) Ltd. Please include your name, your
      ...
      <p>
        No use of Fire Alert Mobi (Pty) Ltd's logo or other artwork will be
        allowed for linking absent a trademark license agreement.
      </p>
    </div>

    <div class="mb-8">
      <h3 class="mb-4 text-2xl font-bold">iFrames</h3>
      <p class="mb-4">
    ...
    <div class="mb-8">
      <h3 class="mb-4 text-2xl font-bold">Content Liability</h3>
      <p class="mb-4">
    ...
    <div class="mb-8">
      <h3 class="mb-4 text-2xl font-bold">Reservation of Rights</h3>
      <p class="mb-4">
    ...
    <div class="mb-8">
      <h3 class="mb-4 text-2xl font-bold">Removal of links from our website</h3>
      <p class="mb-4">
    ...
    <div class="mb-8">
      <h3 class="mb-4 text-2xl font-bold">Disclaimer</h3>
      <p class="mb-4">
