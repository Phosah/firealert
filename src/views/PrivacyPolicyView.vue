<template>
  <section class="max-w-7xl mx-auto px-4 py-10">
    <div class="mb-8">
      ...
      <div class="mb-8">
        <h3 class="mb-4 text-3xl font-bold">Interpretation and Definitions</h3>
        <h4 class="mb-4 text-2xl font-bold">Interpretation</h4>
        <p class="mb-4">
        ...
        <h4 class="mb-4 text-2xl font-bold">Definitions</h4>
        <p class="mb-4">For the purposes of this Privacy Policy:</p>

        <ul class="mb-3 pl-10 list-disc">
          <li class="mb-3">
            <span class="font-bold">Account </span>means a unique account
          ...
          <li class="mb-3">
            <span class="font-bold">Application </span>refers to Fire Alert, the
            software program provided by the Company.
          </li>
          <li class="mb-3">
            <span class="font-bold">Company </span>(referred to as either "the
            Company", "We", "Us" or "Our" in this Agreement) refers to Fire
            Alert Mobi (Pty) Ltd, 37 Ridge rd, Laserpark Honeydew 2040 South
            Africa.
          </li>
          <li class="mb-3">
            <span class="font-bold">Cookies </span>are small files that are
          ...
          <li class="mb-3">
            <span class="font-bold">Country </span>refers to: South Africa
          </li>
          <li class="mb-3">
            <span class="font-bold">Device </span>means any device that can
            access the Service such as a computer, a cellphone or a digital
            tablet.
          </li>
          <li class="mb-3">
            <span class="font-bold">Personal Data </span>is any information that
            relates to an identified or identifiable individual.
          </li>
          <li class="mb-3">
            <span class="font-bold">Service </span>refers to the Application or
            the Website or both.
          </li>
          <li class="mb-3">
          ...
          <li class="mb-3">
            <span class="font-bold">Website </span>refers to Fire Alert,
            accessible from
            <a class="text-blue-600" href="https://www.firealert.mobi"
              >https://www.firealert.mobi</a
            >
          </li>
          <li class="mb-3">
    ...
    <div>
      ...
      <h3 class="mb-4 text-3xl font-bold">Types of Data Collected</h3>
      <h4 class="mb-4 text-2xl font-bold">Personal Data</h4>
      <p class="mb-4">
    ...
    <div class="mb-8">
      <h4 class="mb-4 text-2xl font-bold">Usage Data</h4>
      <p class="mb-4">
    ...
    <div class="mb-8">
      ...
      <ul class="mb-3 pl-10 list-disc">
        <li class="mb-3">Information regarding your location</li>
        <li class="mb-3">
    ...
    <div class="mb-8">
      <h4 class="mb-4 text-2xl font-bold">Tracking Technologies and Cookies</h4>
      <p class="mb-4">
      ...
      <ul class="mb-3 pl-10 list-disc">
        <li class="mb-3">
          <span class="font-bold">Cookies or Browser Cookies. </span>refers to
        ...
        <li class="mb-3">
          <span class="font-bold">Web Beacons. </span>Certain sections of our
      ...
      <ul class="mb-3 pl-10 list-disc">
        <li class="mb-3 font-bold">Necessary / Essential Cookies</li>
        <p class="mb-3">Type: Persistent Cookies</p>
        <p class="mb-3">Administered by: Us</p>
        <p class="mb-3">
          Purpose: These Cookies identify if users have accepted the use of
          cookies on the Website.
        </p>

        <li class="mb-3 font-bold">Functionality Cookies</li>
        <p class="mb-3">Type: Persistent Cookies</p>
        <p class="mb-3">Administered by: Us</p>
        <p class="mb-3">
    ...
    <div class="mb-8">
      <h4 class="mb-4 text-2xl font-bold">Use of Your Personal Data</h4>
      <p class="mb-4">
      ...
      <ul class="mb-3 pl-10 list-disc">
        ...
        <li class="mb-3">
          <span class="font-bold">To provide You </span>with news, special
      ...
      <ul class="mb-3 pl-10 list-disc">
        ...
        <li class="mb-3">
          <span class="font-bold">For business transfers: </span>We may share or
        ...
        <li class="mb-3">
          <span class="font-bold">With business partners: </span>We may share
          Your information with Our business partners to offer You certain
          products, services or promotions.
        </li>
        <li class="mb-3">
          <span class="font-bold">With other users: </span>when You share
        ...
        <li class="mb-3">
          <span class="font-bold">With Your consent: </span>We may disclose Your
    ...
    <div class="mb-8">
      <h4 class="mb-4 text-2xl font-bold">Retention of Your Personal Data</h4>
      <p class="mb-4">
    ...
    <div class="mb-8">
      <h4 class="mb-4 text-2xl font-bold">Transfer of Your Personal Data</h4>
      <p class="mb-4">
    ...
    <div class="mb-8">
      <h4 class="mb-4 text-2xl font-bold">Delete Your Personal Data</h4>
      <p class="mb-4">
    ...
    <div class="mb-8">
      <h3 class="mb-4 text-3xl font-bold">Disclosure of Your Personal Data</h3>
      <h4 class="mb-4 text-2xl font-bold">Business Transactions</h4>
      ...
      <h4 class="mb-4 text-2xl font-bold">Law enforcement</h4>
      <p class="mb-4">
      ...
      <h4 class="mb-4 text-2xl font-bold">Other legal requirements</h4>
      <p class="mb-4">
      ...
      <h4 class="mb-4 text-2xl font-bold">Security of Your Personal Data</h4>
      <p class="mb-4">
    ...
    <div class="mb-8">
      <h3 class="mb-4 text-3xl font-bold">Children's Privacy</h3>
      <p class="mb-4">
    ...
    <div class="mb-8">
      <h3 class="mb-4 text-3xl font-bold">Links to Other Websites</h3>
      <p class="mb-4">
    ...
    <div class="mb-8">
      <h3 class="mb-4 text-3xl font-bold">Changes to this Privacy Policy</h3>
      <p class="mb-4">
    ...
    <div class="mb-8">
      <h3 class="mb-4 text-3xl font-bold">Contact Us</h3>
      <p class="mb-4">
        If you have any questions about this Privacy Policy, You can contact us:
      </p>
      <ul class="mb-3 pl-10 list-disc">
        <li class="mb-3">By email: app@firealert.mobi</li>
      </ul>
    </div>
  </section>
</template>
